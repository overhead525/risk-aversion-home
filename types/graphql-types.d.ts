...
export type SingleBlogPostQuery2QueryVariables = Exact<{ [key: string]: never; }>;


export type SingleBlogPostQuery2Query = { contentfulBlogPost?: Maybe<(
...
export type BirdsEyeViewPostQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type BirdsEyeViewPostQueryQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title'>
    & { body?: Maybe<Pick<ContentfulBlogPostBodyRichTextNode, 'json'>> }
  )> };

export type HomePagePostQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type HomePagePostQueryQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title'>
    & { body?: Maybe<Pick<ContentfulBlogPostBodyRichTextNode, 'json'>> }
  )> };

export type SimulationCorePostQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type SimulationCorePostQueryQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title'>
    & { body?: Maybe<Pick<ContentfulBlogPostBodyRichTextNode, 'json'>> }
  )> };

export type SimulationRequestApiPostQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type SimulationRequestApiPostQueryQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title'>
    & { body?: Maybe<Pick<ContentfulBlogPostBodyRichTextNode, 'json'>> }
  )> };

export type UserInterfacePostQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type UserInterfacePostQueryQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title'>
    & { body?: Maybe<Pick<ContentfulBlogPostBodyRichTextNode, 'json'>> }
  )> };

export type WebApplicationBackendPostQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type WebApplicationBackendPostQueryQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title'>
    & { body?: Maybe<Pick<ContentfulBlogPostBodyRichTextNode, 'json'>> }
  )> };

export type WhoUsesRiskAversionPostQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type WhoUsesRiskAversionPostQueryQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title'>
    & { body?: Maybe<Pick<ContentfulBlogPostBodyRichTextNode, 'json'>> }
  )> };

export type WhyBuildThisPostQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type WhyBuildThisPostQueryQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title'>
    & { body?: Maybe<Pick<ContentfulBlogPostBodyRichTextNode, 'json'>> }
  )> };
